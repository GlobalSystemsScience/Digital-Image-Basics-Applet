...
public class About {
	...
	public About() {
		...
		JLabel info = new JLabel("<html>" +
				...
				"The software was adapted with some revisions to an applet for web use by Jordan Bull, Lawrence Hall of Science, Berkeley, CA.<br><br>" +
				...
				"<br><br>Copyright 2003, 2009, 2011, 2012 by the Regents of the University of California<br>" +
