...
public class Main extends Applet{
	...
	public static final int x=0, y=0, width=1250, height=760;
	...
	public void start() {
	    ...
	    me = this;
	    setSize(200,35);
        JButton start = new JButton("Launch Digital Image Basics");
        start.setSize(50,30);
        start.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent arg0) {
                try{
                    ...
                    //mainDisplay.setAlwaysOnTop(true);
	...
	private void generateDisplay() {
	    mainDisplay.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
	    try{
	    ...
	    mainDisplay.setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
	}
